...
int main(int argc, char* argv[]) {
  // auto Tstart = std::chrono::high_resolution_clock::now();
   ...
   // auto Tcompute = std::chrono::high_resolution_clock::now();
    ...
    std::chrono::duration<double> compute = Tcompute - TI;
    std::chrono::duration<double> in = TI - Tstart;
    std::chrono::duration<double> out = TO - Tcompute;
    std::cout << "Total Input Time: " << in.count()<< "s" << std::endl;
    std::cout << "Total Output Time: " << out.count() << "s" << std::endl;
    std::cout << "Total Compute Time: " << compute.count() << "s" << std::endl;
